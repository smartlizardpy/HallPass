      ...
      <nav className="flex-1 overflow-y-auto px-3 pb-4">
            ...
            return (
              <li key={item}>
                <button
                  ...
                  className={`group flex w-full items-center gap-3 rounded-2xl px-4 py-2.5 text-[15px] font-bold transition ${
                    isActive
        ...
        <ul className="flex flex-col gap-1">
          {[
            ...
            <li key={it.label}>
              <button className="flex w-full items-center gap-3 rounded-2xl px-4 py-2.5 text-[15px] font-bold text-zinc-700 transition hover:bg-surface-2 hover:text-zinc-900">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
